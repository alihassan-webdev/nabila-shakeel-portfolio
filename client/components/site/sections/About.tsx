          ...
          <div className="md:col-span-7">
            <div className="rounded-2xl border bg-card p-8 card-shadow">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <ul className="list-disc pl-5 text-foreground/80 space-y-2">
                  <li>
                    Test Design & Planning: requirements analysis, test
                    strategy, UAT coordination
                  </li>
                  <li>
                    Test Automation: Selenium (Java/Python/C#), Cypress,
                    Playwright, TestNG, JUnit, Cucumber
                  </li>
                  <li>
                    API & Performance Testing: Postman, REST Assured, JMeter,
                    LoadRunner
                  </li>
                </ul>
                <ul className="list-disc pl-5 text-foreground/80 space-y-2">
            ...
            <div className="mt-6 rounded-2xl border bg-card p-6 card-shadow">
              ...
              <p className="mt-2 text-foreground/80 text-sm">
                Familiar with ISO 9001 / ISO 27001 standards, GDPR-compliant
                testing practices and experienced in Financial, Healthcare, and
                EdTech QA environments. Skilled at aligning QA processes with
