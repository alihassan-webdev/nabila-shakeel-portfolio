...
export default function Tools() {
  return (
    <section id="tools" className="scroll-mt-16 lg:scroll-mt-12">
        ...
        <div className="mt-6 grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 justify-items-center">
          {categories.map((c) => {
            ...
            return (
              ...
              >
                <div className="aspect-square w-full max-w-[100px] sm:max-w-[160px] md:max-w-[180px] mx-auto rounded-lg border bg-card p-3 card-shadow flex items-center justify-center relative min-h-[120px] sm:min-h-auto">
                  <div
