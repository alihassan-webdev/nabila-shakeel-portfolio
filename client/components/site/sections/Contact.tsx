        ...
        <div className="grid gap-8 md:grid-cols-2 items-center">
          ...
          <aside className="rounded-[var(--radius)] border bg-card p-6 card-shadow">
            ...
            <div className="flex items-center gap-3">
              <a
                href={`mailto:${email}`}
                className="inline-flex items-center gap-2 rounded-2xl bg-primary px-4 py-2 md:px-4 md:py-2 text-sm font-medium text-primary-foreground shadow-lg hover:opacity-95 transition"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-2xl border bg-background px-4 py-2 md:px-4 md:py-2 text-sm text-foreground/80 hover:bg-blue-50 hover:border-blue-300 hover:text-blue-600 transition"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-2xl border bg-background px-4 py-2 md:px-4 md:py-2 text-sm text-foreground/80 hover:bg-green-50 hover:border-green-300 hover:text-green-600 transition"
                aria-label="WhatsApp"
                title="WhatsApp"
              >
