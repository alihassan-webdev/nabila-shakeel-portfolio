      ...
      <div className="container py-20">
        <div className="grid gap-8 md:grid-cols-2 items-start">
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center rounded-full border border-foreground/12 px-4 py-2 text-sm font-medium text-foreground/80 hover:bg-foreground/5 transition"
              >
                LinkedIn Profile
              </a>
          ...
          <aside className="rounded-2xl border bg-card p-6 card-shadow">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href="#" className="text-sm inline-flex items-center rounded-full border border-foreground/10 px-3 py-1 text-foreground/80 hover:bg-foreground/5">Download CV</a>
            </div>
          </aside>
        </div>
      </div>
