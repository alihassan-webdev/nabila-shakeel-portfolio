      ...
      <div className="container py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border bg-card p-6 card-shadow">
            ...
            <p className="mt-2 text-sm text-foreground/80">Selenium, Cypress, Playwright, Postman, REST Assured, JMeter, Docker, Kubernetes, Jenkins, GitLab CI, GitHub Actions</p>
          </div>

          <div className="rounded-2xl border bg-card p-6 card-shadow">
            <h4 className="font-semibold">Methodologies</h4>
            <p className="mt-2 text-sm text-foreground/80">Shift-left testing, BDD with Cucumber, exploratory testing, performance benchmarking, security testing and compliance validation.</p>
          </div>
        </div>
      </div>
    </section>
